...
public:
    ...
    *	验证密码
    */
    int QF_veriPassword(char *pUsername, char *pPassword);
    int QF_setPassword(char *pUsername, char *pPassword);

    /**
    *	获取当前用户
    */
    int QF_getUserName(char *pUser);
    ...
    *	获取用户信息
    */
    StUserEx* QF_getUsers();

    StUserEx *QF_getUserInfoByUserName(char *username, int fg_id);
    ...
    *	添加、修改用户信息
    */
    int QF_userAdd(StUserEx *pUser);

    /**
    *	删除用户信息
    */
    int QF_userDel(StUserEx *pUser);


    /**
    *	保存指静脉信息
    */
    int QF_veinAdd(StVeinEx *pVein);

    /**
    *	删除指静脉信息
    */
    int QF_veinDel(StVeinEx *pVein);

    /**
     * 删除用户指静脉信息
     */
    int QF_delVein(StVeinEx *pVein);
