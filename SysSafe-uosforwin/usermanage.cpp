...
int UserManage::QF_veriPassword(char *pUsername, char *pPassword)
{
    _StFunParamAndRes param;
...
int UserManage::QF_setPassword(char *pUsername, char *pPassword)
{
    _StFunParamAndRes param;
...
int UserManage::QF_getUserName(char *pUser)
{
    _StFunParamAndRes param;
...
StUserEx* UserManage::QF_getUsers()
{
    _StFunParamAndRes param;
...
StUserEx *UserManage::QF_getUserInfoByUserName(char *username, int fg_id)
{
    _StFunParamAndRes param;
...
int UserManage::QF_userAdd(StUserEx *pUser)
{
    _StFunParamAndRes param;
...
int UserManage::QF_userDel(StUserEx *pUser)
{
    _StFunParamAndRes param;
...
int UserManage::QF_veinAdd(StVeinEx *pVein)
{
    _StFunParamAndRes param;
...
int UserManage::QF_veinDel(StVeinEx *pVein)
{
    _StFunParamAndRes param;
...
int UserManage::QF_delVein(StVeinEx *pVein)
{
    _StFunParamAndRes param;
